                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: _isLoading
                                ...
                                : ElevatedButton(
                                    ...
                                    style: ElevatedButton.styleFrom(backgroundColor: const Color(0xFF3D4CD6), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8))),
                                    child: const Text('Join and Sign In', style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w500)),
                                  ),
                          ),
                          ...
                          TextButton(
                            ...
                            child: const Text('Back to Login', style: TextStyle(fontSize: 14, color: Color(0xFF3D4CD6), decoration: TextDecoration.none)),
                          ),
                        ],
                      ),
                    ),
